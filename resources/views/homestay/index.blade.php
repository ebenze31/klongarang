...
$sql = "SELECT photo_1 ,photo_2, photo_3, photo_4, photo_5, photo_6 FROM homestays ORDER BY RAND() LIMIT 0,1";
                                ...
                                <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                                  ...
                                  <div class="carousel-inner">
                                    <div class="carousel-item active">
                                      <img height="300" src="{{ url('storage')}}/{{ $photo_1 }}" class="d-block w-100" alt="">
                                      
                                    </div>
                                    <div class="carousel-item">
                                      <img height="300" src="{{ url('storage')}}/{{ $photo_2 }}" class="d-block w-100" alt="...">
                                      
                                    </div>
                                    <div class="carousel-item">
                                      <img height="300" src="{{ url('storage')}}/{{ $photo_3 }}" class="d-block w-100" alt="...">
