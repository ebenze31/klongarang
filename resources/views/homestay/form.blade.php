...
<div class="form-group {{ $errors->has('home') ? 'has-error' : ''}}">
    <label for="home" class="control-label">{{ 'บ้านเลขที่' }}</label><span style="color: red"> *</span>
    <textarea class="form-control" rows="5" name="home" type="textarea" id="home" required>{{ isset($homestay->home) ? $homestay->home : ''}}</textarea>
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="form-group {{ $errors->has('photo_1') ? 'has-error' : ''}}">
                ...
                <input class="form-control" name="photo_1" type="file" id="photo_1" value="{{ isset($homestay->photo_1) ? $homestay->photo_1 : ''}}" required>
            ...
            <div class="form-group {{ $errors->has('photo_2') ? 'has-error' : ''}}">
                ...
                <input class="form-control" name="photo_2" type="file" id="photo_2" value="{{ isset($homestay->photo_2) ? $homestay->photo_2 : ''}}" required>
            ...
            <div class="form-group {{ $errors->has('photo_3') ? 'has-error' : ''}}">
                ...
                <input class="form-control" name="photo_3" type="file" id="photo_3" value="{{ isset($homestay->photo_3) ? $homestay->photo_3 : ''}}" required>
        ...
        <div class="col-lg-6">
            ...
            <div class="form-group {{ $errors->has('photo_4') ? 'has-error' : ''}}">
                ...
                <input class="form-control" name="photo_4" type="file" id="photo_4" value="{{ isset($homestay->photo_4) ? $homestay->photo_4 : ''}}" required>
            ...
            <div class="form-group {{ $errors->has('photo_5') ? 'has-error' : ''}}">
                ...
                <input class="form-control" name="photo_5" type="file" id="photo_5" value="{{ isset($homestay->photo_5) ? $homestay->photo_5 : ''}}" required>
            ...
            <div class="form-group {{ $errors->has('photo_6') ? 'has-error' : ''}}">
                ...
                <input class="form-control" name="photo_6" type="file" id="photo_6" value="{{ isset($homestay->photo_6) ? $homestay->photo_6 : ''}}" required>
